...
export default Component.extend({
  ...
  actions: {
    setAccessoryCount(value) {
      ...
      const accessory = get(this, "exteriors").findBy("id", accessoryId);

      get(this, "setAccessoryCount")(accessoryId, value, "exteriors");
    ...
    toggleAccessory(id, type, price) {
      const accessory = get(this, "exteriors").findBy("id", id);
